...
function Edit({
  ...
  const ALLOWED_BLOCKS = wp.blocks.getBlockTypes().map(block => block.name).filter(blockName => !excludedBlocks.includes(blockName));
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/slide/block.json");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_slide_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks/slide/index */ "./src/blocks/slide/index.js");
...
module.exports = JSON.parse('{"apiVersion":3,"name":"nikita-test-block/slide","version":"0.1.0","title":"Slide Block","category":"nikita-dev-gutenberg-blocks","icon":"cover-image","description":"","parent":["nikita-test-block/slider"],"supports":{"html":false,"anchor":true},"textdomain":"nikita-test-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
